...
import { Tabs, TabsList, TabsTrigger } from "@/ui/src/tabs";
...
export const ProblemSubmitBar = ({
  ...
  const bodyStyles = {
    backgroundColor: "#ffffff", // White background (or use other color)
  ...
  const dropdownStyles = {
    ...
    border: "1px solid #e5e5e5", // Border for dropdown
  };
